      ...
      <div style={{ backgroundColor: 'var(--surface)', padding: '32px', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--outline-variant)' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div className="form-row" style={{ gap: '20px' }}>
            <div style={{ flex: 1 }}>
              <label className="text-label-md" style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>{t('createGroup.form.codeLabel')}</label>
              <input 
                type="text" 
                name="groupCode"
            ...
            <div style={{ flex: 1 }}>
              <label className="text-label-md" style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>{t('createGroup.form.nameLabel')}</label>
              <input 
                type="text" 
                name="groupName"
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '16px' }}>
            ...
            <Button 
              ...
              disabled={loading}
            >
              {loading ? t('createGroup.form.saving') : t('createGroup.form.btnSave')}
            </Button>
          </div>
        </form>
      </div>
